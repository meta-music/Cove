	...
	<view class="u-bg-malandy-g2" :style="defaultHeight">
		<view class="u-p-10">
			...
			<view class="u-radius-3  u-font-white u-p-10 u-m-t-10 u-font-size-12"
				>
				<view class="u-p-b-5 text-center">创作星记使你心情变好了吗?</view>
				<view class="u-p-b-5 text-center">添加标签</view>
				<MoodList></MoodList>
			</view>
		</view>
